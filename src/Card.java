...
public class Card {
	protected /*@ spec_public @*/ Client owner = new Client("Client User", 22, "UFRN", "001.222.345", "075.573.249", 54321);
	...
	public Card(Client owner){
		...
		Card.cardsAmount++;
		this.cardNumber = expMonth*10000000 + expYear*1000 + Card.cardsAmount;	// generates a number like '122022001' just because ;D
	...
	public void useCard(double purchaseValue, int pass) {
		if (pass == owner.getPass()) {
			System.out.println("EEEEEEEEEEEEEEEEEEEEENTROOOOOU");
